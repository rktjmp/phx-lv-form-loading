defmodule FormLoadingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FormLoadingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FormLoadingWeb.Gettext, "errors", msg, opts)
    end
  end
